...
model.fit(train_data, epochs=10, validation_data=validation_data, callbacks=[tf.keras.callbacks.EarlyStopping(patience=1, verbose=1, min_delta=0.001, restore_best_weights=True)])
model.evaluate(test_data)

model.save('pubmed_cbow_embeddings.h5')