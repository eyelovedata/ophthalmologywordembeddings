...
width = 1000
class_weights = [1, 1]
picklefile = 'glovedict.pickle'
vocabularyfile = 'glove_vocabulary.txt'
...
with open(vocabularyfile, 'r') as g:
    vocabulary = []
    for word in g:
...
for word in vocabulary:
    if word in gloveDict:
        embedding_matrix[i] = gloveDict[word]
    i += 1
...
model.save_weights('glove_unstructured_lowvaextrinsic.h5')